...
public class User_Profile {
	...
	public User_Profile(String user_ID, String user_PW, String user_nickName, String user_phoneNumber, String user_name,
			String user_email, String user_country, String user_city, Date user_birthDay, int level, String regDate,
			String user_contents, int follower, int followed) {
		super();
