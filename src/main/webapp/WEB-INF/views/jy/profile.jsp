...
<div>모두 가운데로 배치</div>
<div>배경 사진</div>
<div><img src="resources/files/${sessionScope.loginMember.pf_Img }"> </div>
<div>프로필 사진 </div>
<div><img src="resources/files/${sessionScope.loginMember.pf_bgImg }"> </div>
<div>닉네임</div>
...
<div>자기소개</div>
<div>${sessionScope.loginMember.pf_contents }</div>
<div>생일 (변경 불가)</div>
